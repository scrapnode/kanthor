...
let enumsMap: Set<string> = new Set<string>([
    "RestEndpointCreateReqMethodEnum",
]);
...
let typeMap: {[index: string]: any} = {
    ...
    "RestAccountGetRes": RestAccountGetRes,
    "RestApplicationCreateReq": RestApplicationCreateReq,
    ...
    "RestEndpointCreateRes": RestEndpointCreateRes,
    "RestEndpointDeleteRes": RestEndpointDeleteRes,
    "RestEndpointGetRes": RestEndpointGetRes,
    "RestEndpointListRes": RestEndpointListRes,
    "RestEndpointRuleCreateReq": RestEndpointRuleCreateReq,
    "RestEndpointRuleCreateRes": RestEndpointRuleCreateRes,
    "RestEndpointRuleDeleteRes": RestEndpointRuleDeleteRes,
    "RestEndpointRuleGetRes": RestEndpointRuleGetRes,
    "RestEndpointRuleListRes": RestEndpointRuleListRes,
    "RestEndpointRuleUpdateReq": RestEndpointRuleUpdateReq,
    "RestEndpointRuleUpdateRes": RestEndpointRuleUpdateRes,
    "RestEndpointUpdateReq": RestEndpointUpdateReq,
    "RestEndpointUpdateRes": RestEndpointUpdateRes,
    "RestMessagePutReq": RestMessagePutReq,
    "RestMessagePutRes": RestMessagePutRes,
}

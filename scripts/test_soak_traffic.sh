...
export TEST_VUS=${K6_VUS:-"10"}
export TEST_DURATION_START=${K6_START_DURATION:-"1m"}
export TEST_DURATION_MID=${K6_MID_DURATION:-"3m"}
export TEST_DURATION_END=${K6_MID_DURATION:-"1m"}

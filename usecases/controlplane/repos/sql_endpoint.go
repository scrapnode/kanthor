...
func (sql *SqlEndpoint) List(ctx context.Context, appId string, opts ...structure.ListOps) (*structure.ListRes[entities.Endpoint], error) {
	req := structure.ListReqBuild(opts)
	res := structure.ListRes[entities.Endpoint]{}

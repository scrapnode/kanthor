...
func (sql *SqlEndpointRule) List(ctx context.Context, epId string) (*structure.ListRes[entities.EndpointRule], error) {
	res := structure.ListRes[entities.EndpointRule]{}

...
type EndpointRuleClient interface {
	...
	Get(ctx context.Context, in *EndpointRuleGetReq, opts ...grpc.CallOption) (*EndpointRuleEntity, error)
}
...
func (c *endpointRuleClient) List(ctx context.Context, in *EndpointRuleListReq, opts ...grpc.CallOption) (*EndpointRuleListRes, error) {
	...
	err := c.cc.Invoke(ctx, "/kanthor.controlplane.v1.EndpointRule/List", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *endpointRuleClient) Get(ctx context.Context, in *EndpointRuleGetReq, opts ...grpc.CallOption) (*EndpointRuleEntity, error) {
	out := new(EndpointRuleEntity)
	err := c.cc.Invoke(ctx, "/kanthor.controlplane.v1.EndpointRule/Get", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type EndpointRuleServer interface {
	...
	Get(context.Context, *EndpointRuleGetReq) (*EndpointRuleEntity, error)
...
func (UnimplementedEndpointRuleServer) Get(context.Context, *EndpointRuleGetReq) (*EndpointRuleEntity, error) {
...
func _EndpointRule_List_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/kanthor.controlplane.v1.EndpointRule/List",
	}
...
func _EndpointRule_Get_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/kanthor.controlplane.v1.EndpointRule/Get",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var EndpointRule_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "kanthor.controlplane.v1.EndpointRule",
